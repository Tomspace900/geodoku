export const en = {
  ...
  howToPlay: {
    ...
    rule4Body:
      "The rarer your country among today's players' picks, the higher its rarity tier — and the more it scores.",
  ...
  scoring: {
    ...
    gridBody: "50 points per filled cell (up to 450).",
    rarityBody:
      "The rarer your countries — picked by fewer of today's players — the more they score. A common country gives no bonus.",
    lives: "Lives",
    livesBody: "20 points per remaining life (up to 100).",
    estimated: "Estimated score — few players so far today, it'll sharpen.",
    legendTitle: "The rarity tiers",
    legendCommon: "Picked by more than 50\u00A0% of players",
    legendUncommon: "Picked by 25 to 50\u00A0% of players",
    legendRare: "Picked by 10 to 25\u00A0% of players",
    legendUltra: "Picked by 10\u00A0% of players or fewer",
    grid: "Grid",
    rarity: "Rarity",
    points: "pts",
  },

...
export const fr = {
  ui: {
    ...
    constraintAnswerCount: "{count} pays",
    yourPick: "Ton choix",
  ...
  countrySheet: {
    ...
    value: {
      ...
      utcOffsetsCountSingular: "{count} décalage horaire distinct",
      utcOffsetsCountPlural: "{count} décalages horaires distincts",
    ...
    enum: {
      ...
      sovereigntyKind: {
        ...
        dissolution_successor: "Succession d'État",

export const en = {
  ...
  countrySheet: {
    ...
    value: {
      ...
      none: "None",
      noneFeminine: "None",
      capitalNotLargest: "not the largest city",
      areaUnit: "{value} km²",
      densityUnit: "{value} people/km²",
      sovereigntyValue: "{kind} ({year})",
    ...
    enum: {
      ...
      event: {
        fifaWcHost: "FIFA World Cup host",
        summerOlympicsHost: "Summer Olympics host",
        winterOlympicsHost: "Winter Olympics host",
      },
      politicalGroup: {
      ...
      sovereigntyKind: {
        ...
        restoration: "Restoration of independence",
        separation: "Separation",
        dissolutionSuccessor: "Successor state after dissolution",
        continuation: "Continuation of an existing state",

export const en = {
  ui: {
    ...
    constraintAnswerCount: "{count} countries",
    yourPick: "Your pick",
  ...
  countrySheet: {
    ...
    value: {
      ...
      areaUnit: "{value} km²",
      sovereignty: "{kind} ({when})",
      densityUnit: "{value} people/km²",
      utcOffsetsCountSingular: "{count} distinct UTC offset",
      utcOffsetsCountPlural: "{count} distinct UTC offsets",
    ...
    enum: {
      ...
      sovereigntyKind: {
        ...
        dissolution_successor: "State succession",

...
export const fr = {
  ...
  countrySheet: {
    ...
    value: {
      ...
      none: "Aucun",
      noneFeminine: "Aucune",
      capitalNotLargest: "n'est pas la plus grande ville",
      areaUnit: "{value} km²",
    ...
    enum: {
      ...
      event: {
        fifaWcHost: "Hôte de la Coupe du monde de football",
        summerOlympicsHost: "Hôte des Jeux olympiques d'été",
        winterOlympicsHost: "Hôte des Jeux olympiques d'hiver",
      },
      politicalGroup: {
      ...
      sovereigntyKind: {
        ...
        restoration: "Restauration de l'indépendance",
        separation: "Séparation",
        dissolutionSuccessor: "État successeur après dissolution",
        continuation: "Continuité d'un État existant",
